...
export default function Projects() {
  ...
  // Default projects to show immediately (sleek transition)
  ...
  // Use API projects if available, otherwise use defaults
          ...
          {displayProjects.map((project, i) => {
            ...
            return (
              <Card
                key={`p_${i}`}
                i={i}
                url={project.src ? (project.src.startsWith('http') ? project.src : `${API_URL}${project.src}`) : project.link}
                title={project.title}
                color={project.color}
        ...
        <div className="w-full flex flex-col md:flex-row bg-zinc-900 rounded-2xl overflow-hidden shadow-xl">
          ...
          <div className="w-full md:w-[45%] p-6 md:p-8 lg:p-10 flex flex-col justify-between">
            <div>
              ...
              {tagline && <p className="text-sm md:text-base text-gray-300 italic mb-2">{tagline}</p>}
